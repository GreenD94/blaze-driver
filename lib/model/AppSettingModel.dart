...
class AppSettingModel {
    ...
    AppSettingModel({this.region, this.rideSetting, this.walletSetting, this.currencySetting, this.settingModel, this.privacyPolicyModel, this.termsCondition, this.usdRate});
