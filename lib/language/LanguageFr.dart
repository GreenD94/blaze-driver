...
class LanguageFr extends BaseLanguage {
  ...
  String get enterTheEmailAssociatedWithYourAccount =>
      'Entrez l\'e -mail associéàvotre compte';
  ...
  String get pleaseEnableLocationPermission =>
      'Veuillez activer l\'autorisation delocalisation';
  ...
  String get areYouSureYouWantToCancelThisRequest =>
      'Êtes-vous sûr que vous souhaitez annuler cette demande?';
  ...
  String get enterTheOtpDisplayInCustomersMobileToStartTheRide =>
      'Entrez l\'affichage OTPdans lesclients mobilespour démarrer letrajet';
  ...
  String get areYouSureYouWantToCompletedThisRide =>
      'Êtes-vous sûr de vouloir terminer cette balade?';
  ...
  String get userNotApproveMsg =>
      'Votre profil est en cours d\'examen.Attendez unpeu detemps ouun contactavec votreadministrateur.';

  @override
  String get uploadFileConfirmationMsg =>
      'Êtes-vous sûr que vous souhaitez télécharger ce fichier?';
  ...
  String get mostReliableMightyDriverApp =>
      'Application de pilote puissante la plus fiable';
  ...
  String get areYouSureCollectThisPayment =>
      'Êtes-vous sûr de percevoir ce paiement?';
  ...
  String get yourSubscriptionPlanIsOver =>
      'Votre plan d\'abonnement est terminé. Veuillez vous abonner pour utiliser cette application';
  ...
  String get yourWalletDoNotHaveEnoughBalance =>
      'Votre portefeuille n\'a pas assez d\'équilibre. Veuillez ajouter l\'équilibre dans le portefeuille puis renouveler votre plan d\'abonnement.';
  ...
  String get yourDailyAppUseLimitHasBeenExpired =>
      'Votre limite d\'utilisation quotidienne de l\'application a été expirée. Appuyez sur pour recharger et utilisez l\'application.';
