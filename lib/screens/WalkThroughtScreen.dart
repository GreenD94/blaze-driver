...
class WalkThroughtScreenState extends State<WalkThroughtScreen> {
  ...
  List<WalkThroughModel> walkThroughClass = [
    WalkThroughModel(
      name: 'Conviértete en tu\n propio jefe',
      text: "gana dinero conduciendo \ncon nuestra aplicación de conductores",
      img: 'images/ic_walk1.jpg',
    ),
    WalkThroughModel(
      name: 'Conduces en tu\n tiempo libre',
      text: "Con nuestra aplicación de conductores",
      img: 'images/ic_walk2.jpg',
    ),
    WalkThroughModel(
      name: 'Únete a nuestra \nred de conductores',
      text: "Descubre cómo puedes \nganar dinero de forma fácil y rápida",
